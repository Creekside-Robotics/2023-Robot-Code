...
public class ThirdLevelScore extends SequentialCommandGroup {
    public ThirdLevelScore(Arm lower, Arm upper, Claw claw) {
        ...
        super(
                ...
                new MoveArmsToPosition(lower, upper, ArmPositions.lowerTranscendentalThree, ArmPositions.upperTranscendentalThree, 0.1),
